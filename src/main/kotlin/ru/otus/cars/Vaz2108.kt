...
class Vaz2108 private constructor(color: String) : VazPlatform(color) {
    ...
    // Топливная система - бензиновая
    override val tankMouth: TankMouth = TankMouth.PetrolMouth
    override val tank: Tank = Tank.createStandardTank(capacity = 50.0)
    ...
    override fun toString(): String {
        return "Vaz2108(plates=$plates, wheelAngle=$wheelAngle, currentSpeed=$currentSpeed, fuelLevel=${tank.getFuelLevel()} л)"
    }
    ...
    inner class VazOutput : CarOutput {
        ...
        override fun getFuelLevel(): Double {
            return this@Vaz2108.tank.getFuelLevel()
        }
    }
}