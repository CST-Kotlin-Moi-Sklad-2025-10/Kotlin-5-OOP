...
class Vaz2107 private constructor(color: String) : VazPlatform(color) {
    ...
    companion object : CarBuilder {
        ...
        override fun build(plates: Car.Plates): Vaz2107 = Vaz2107("Зеленый").apply {
            ...
            this.plates = plates
            tank = CommonFuelTank.build(45)
            tankMouth = PetrolMouth.build(tank)
        }
    ...
    override fun toString(): String {
        return "Vaz2107(plates=$plates, wheelAngle=$wheelAngle, currentSpeed=$currentSpeed), currentPetrol=${tank.getContents()}"
    }
